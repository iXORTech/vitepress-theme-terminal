...
// and the temporary floating-window demo trigger (THEME-003 — replaced by the
// find palette's search trigger when SEARCH-002 lands). Configurable nav
// entries and extra action icons arrive with THEME-005.
